...
- [results-sort-filter-export-baseline.md](results-sort-filter-export-baseline.md) defines the allowed sort, filter, and export behavior for public release views and richer portal result surfaces
