...
const validationMessagePatterns = [
  ...
  /^Passing bundles require compiler-diagnostics\.json success=true\./u,
  /^Passing bundles may not include a failure classification\./u,
  /^Compile failure classifications require compiler-diagnostics\.json success=false\./u,
  /^Passing verdicts may not include a failure classification\./u,
  /^Passing verdicts require semanticEquality=matched\./u,
  /^Passing verdicts may not contain sorry or admit\./u,
  /^Passing verdicts require axiomCheck=passed\./u,
  /^Passing verdicts require diagnosticGate=passed\./u,
